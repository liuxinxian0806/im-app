...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({ user }) => {
  return (
    <div className="relative bg-gradient-to-b from-blue-50 to-white border-b border-slate-100 overflow-hidden">
      {/* Decorative background element */}
      <div className="absolute -right-4 -top-4 w-32 h-32 bg-blue-100/40 rounded-full blur-3xl" />

      {/* Container to match middle area width (max-w-4xl mx-auto) */}
      <div className="max-w-4xl mx-auto px-6 py-8 relative z-10">
        <div className="flex items-center justify-between">
          ...
          <button 
            className="p-3 bg-white/80 backdrop-blur-sm hover:bg-white hover:shadow-md rounded-xl transition-all text-slate-600 border border-slate-100"
